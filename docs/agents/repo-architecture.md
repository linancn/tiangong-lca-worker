...
lastReviewedNote: "Updated for Worker Issue #179: fresh closure publication uses a small v4 binding bundle, bounded administrative partitions, and pre-write-set object admission without changing public DTO ownership."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
  - ./repo-validation.md
