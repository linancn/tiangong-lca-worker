...
lastReviewedNote: "Issue #148 keeps scope-closure graph finalization off the Tokio runtime, computes canonical sort keys once, and exposes phase timings for capacity diagnosis."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
  - ./repo-validation.md
