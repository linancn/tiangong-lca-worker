...
lastReviewedNote: "Reviewed for Worker Issue #199: private snapshot persistence is an explicit Worker direct-PostgreSQL consumer boundary while database-engine remains schema owner."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
  - ./repo-validation.md
