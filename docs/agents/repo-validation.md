...
lastReviewedNote: "Updated for Worker Issue #223: adds numerical snapshot and release-evidence sidecar proof requirements."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
