...
lastReviewedNote: "Updated for Issue #249: validation now proves joint pending-review diagnostics complete informationally and never block Review workflow."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
