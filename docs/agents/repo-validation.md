...
lastReviewedNote: "Updated for Issue #171 with >2 GiB production-fan-out recovery, partition-candidate comparison, deterministic dual-run, and 1x/2x/5x/10x bounded-RSS proof requirements."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
