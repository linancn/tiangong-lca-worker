...
lastReviewedNote: "Updated for Worker Issue #177 and Database #316 with canonical v3 semantic-equivalence, zero-expansion, double-run determinism, production-distribution scaling, and staged-publication failure gates."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
