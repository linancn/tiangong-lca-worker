...
lastReviewedNote: "Reviewed for Worker Issue #199: private snapshot cutover proof now combines scoped static diagnostics with an isolated dedicated-login and disposable lifecycle qualification."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
