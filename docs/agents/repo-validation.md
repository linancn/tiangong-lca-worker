...
lastReviewedNote: "Reviewed for Worker Issues #192, #198, and #199: runtime, scope-closure, real-DB, and docpact proof cover private hash helpers; the fixture preflights its exact 34-document TIDAS 0.1.3 closure; and private snapshot proof combines scoped static diagnostics with isolated dedicated-login lifecycle qualification."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
