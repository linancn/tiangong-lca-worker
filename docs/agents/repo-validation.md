...
lastReviewedNote: "Updated for Issue #169 with real-package and high-unique issue/affected-root external-sort capacity proof requirements."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
