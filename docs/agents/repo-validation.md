...
lastReviewedNote: "Validation now covers the V3-only continuous lease guard, renewal cancellation races, metadata preservation, and queue source order."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
