...
lastReviewedNote: "Validation now covers active-renewal completion fencing, short-lease margin, and the production solver runtime's minimum executor capacity."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
