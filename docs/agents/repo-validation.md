...
lastReviewedNote: "Updated for Issue #174 with the 5,608-global-root/~7-reachable-root admission regression, genuine low-space failure, deterministic dual-run, and 1x/2x/5x/10x bounded-RSS proof requirements."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
