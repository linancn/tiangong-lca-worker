...
lastReviewedNote: "Updated for Worker Issue #179 with monolith-regression, per-object ceiling, v4 administrative partition, double-run determinism, production-width scaling, and Linux cgroup gates."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
