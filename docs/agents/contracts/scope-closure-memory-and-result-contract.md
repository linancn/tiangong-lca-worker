...
lastReviewedNote: "Updated for Worker Issue #186: root-compatible external/provider child results are generated by tracked fail-closed executables, with exact four-mode identity and owner-evidence boundaries."
related:
  - ../../../AGENTS.md
  - ../../../.docpact/config.yaml
