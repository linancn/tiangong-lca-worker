...
lastReviewedNote: "Reviewed for Worker Issue #190: schema-qualified worker job and artifact access does not change scope-closure memory or result semantics."
related:
  - ../../../AGENTS.md
  - ../../../.docpact/config.yaml
