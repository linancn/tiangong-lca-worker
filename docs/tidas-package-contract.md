...
lastReviewedNote: "Reviewed for Issue #163: scope-closure issue partitioning preserves the published TIDAS logical issue-stream hash and does not change package import/export semantics."
related:
  - AGENTS.md
  - .docpact/config.yaml
  - docs/agents/repo-validation.md
