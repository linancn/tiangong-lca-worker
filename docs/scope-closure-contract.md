...
lastReviewedNote: "Updated for Worker Issue #231: exact requested LCIA methods, active C-factor source closure, target-based blocker aggregation, and streaming XLSX limits."
related:
  - AGENTS.md
  - .docpact/config.yaml
  - docs/lca-api-contract.md
