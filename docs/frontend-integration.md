...
lastReviewedNote: "Reviewed for Worker Issue #192: the Worker service-side API cutover does not change the frontend projection or direct-access prohibition."
related:
  - AGENTS.md
  - .docpact/config.yaml
  - docs/lca-api-contract.md
