...
lastReviewedNote: "Reviewed for Issue #172 on the merged #174 baseline: measured-topology admission preserves bounded API projections, while role-tagged, directly partitioned, manifest-addressed complete relations carry trusted seven-day artifact expiry."
related:
  - AGENTS.md
  - .docpact/config.yaml
  - docs/provider-linking.md
