...
lastReviewedNote: "Reviewed for Issue #172 on the merged #174 baseline and Database #309 final contract commit 837948a: bounded owner/download projections remain distinct from the manifest-addressed complete partition result and its trusted seven-day artifact expiry."
related:
  - AGENTS.md
  - .docpact/config.yaml
  - docs/provider-linking.md
