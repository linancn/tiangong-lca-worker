...
lastReviewedNote: "Reviewed for Worker Issue #209: exact-private snapshot-GC audit DML is internal maintenance persistence and changes no job payload, result, Edge, or Next DTO."
related:
  - AGENTS.md
  - .docpact/config.yaml
  - docs/provider-linking.md
