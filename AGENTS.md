...
lastReviewedNote: "Reviewed for Issue #165 bounded all-unit results and factorization cache delivery; repo ownership and branch/runtime boundaries remain unchanged."
related:
  - .docpact/config.yaml
