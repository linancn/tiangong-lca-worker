...
lastReviewedNote: "Reviewed for Worker Issue #198: a schema-valid lifecycle fixture and its preflight remain test-owned and do not alter Worker orchestration or repository ownership."
related:
  - .docpact/config.yaml
