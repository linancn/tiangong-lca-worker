...
lastReviewedNote: "Reviewed for Worker Issue #199: the snapshot persistence family moves to exact private direct-PostgreSQL identities without moving durable schema ownership out of database-engine."
related:
  - .docpact/config.yaml
